...
- `lib/src/features/<f>/{domain,data,application,presentation}/` — auth · profile · friends · **groups** (cercles) · thoughts · settings · home · **home_widget** · **ambient** (son) · **notifications** (push groupé).
